...
In this application I **will not use** all the features and capabilities of Express.js but, I will use it for the endpoint as it became an **industry standard** to use with Node.js (e.g., MERN, MEAN, etc.).
